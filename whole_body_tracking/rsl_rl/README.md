...
This fork supports **PPO** and the PHP **DistillPPO depth-student route**. The legacy standalone
student-teacher distillation implementation has been removed to keep a single training path.
